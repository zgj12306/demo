 ...
 */
final class Version20210718150428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chapter (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, layer INT NOT NULL, sort INT NOT NULL, parent_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
